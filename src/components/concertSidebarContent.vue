  ...
  <div v-if="rightMenuVisible">
    ...
    >
      <div class="sidebar-container">
        <q-img :src="rightMenuConcert.image" style=" height: 30vh;">
        </q-img>
        <div class="info-container">
          <span style="font-size:1.75em; font-weight: bold">{{ rightMenuConcert.name }}</span>
          <span
            style="font-size:1em;">Openers: {{
              rightMenuConcert.openers === '' ? 'No Openers listed' : rightMenuConcert.openers
            }}</span>
        ...
        <div class="button-container">
          ...
          <q-card v-if="going" class="icon-container" @click="handleInteraction(rightMenuConcert, 'GOING')" style="background: #2096f3;">
...
<!--              >-->
<!--                &lt;!&ndash;                <template v-if="overlay" v-slot:overlay>&ndash;&gt;-->
<!--                &lt;!&ndash;                  <div>&ndash;&gt;-->
<!--                &lt;!&ndash;                    <img&ndash;&gt;-->
<!--                &lt;!&ndash;                      src="quasar-logo.png"&ndash;&gt;-->
<!--                &lt;!&ndash;                      style="width: 30vw; max-width: 50px; opacity: 0.25;"&ndash;&gt;-->
<!--                &lt;!&ndash;                    >&ndash;&gt;-->
<!--                &lt;!&ndash;                  </div>&ndash;&gt;-->
  ...
  methods: {
    ...
    handleInterested(data) {
      ...
      if (!this.interested) {
        ...
        this.going = false
        this.$store.dispatch('profile/removeGoingConcert', data)
        this.$q.notify({
        ...
        this.$store.dispatch('profile/removeInterestedConcert', data)
        this.$q.notify({
    ...
    checkIfInterested() {
      ...
      this.events.interested.forEach(event => {
        console.log('this.rightMenuConcert.id', this.rightMenuConcert.id)
        console.log('event.id', event.id)
        if (event.id === this.rightMenuConcert.id) {
    ...
    checkIfGoing() {
      ...
      this.$store.dispatch('profile/checkGoingConcerts')
